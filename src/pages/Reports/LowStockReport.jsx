...
import LowStockService from "../../service/LowStockService";
...
const LowStockReport = () => {
  ...
  // Fetch data for the Low Stock Report
  const fetchData = async () => {
    setLoading(true);
    try {
      const response = await LowStockService.getLowStockList();
  ...
  const handleGenerateExcel = async () => {
    ...
    try {
      const response = await LowStockService.generateExcelReport();
      ...
      let fileName = "low_stock_report.xlsx"; // Default file name
