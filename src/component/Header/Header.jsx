...
//   return (
//     <header className="fixed top-0 left-0 z-50 w-full px-4 py-3 text-white bg-gray-800 shadow-lg">
...
//                         className="block px-4 py-2 text-white no-underline rounded-md hover:bg-gray-600"
//                       >
//                         {service.description}
//                       </NavLink>
//                     </li>
...
//               </li> */}
//               <li className="relative group">
//                 <div className="flex items-center justify-center px-4 py-2 text-xl transition-all duration-300 rounded-md cursor-pointer hover:text-yellow-400">
//                   <span>Services</span>
//                   <svg
...
//                   </svg>
//                 </div>
//                 <ul className="absolute hidden p-2 space-y-2 text-center text-white transform -translate-x-1/2 bg-gray-700 rounded-md shadow-lg left-1/2 group-hover:block w-max">
//                   {services.map((service, index) => (
//                     <li key={index}>
//                       <NavLink
//                         to={`/services/${service.eventType}`}
...
//               <NavLink
//                 to="/login"
//                 className="px-6 py-2 text-xl no-underline transition-all duration-300 rounded-lg hover:text-yellow-400"
//               >
//                 Login
//               </NavLink>
//               <SignUpButton />
